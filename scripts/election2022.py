...
df_pivot['gagnant'] = df_pivot[['LREM', 'RN', 'LFI', 'Reconuête', 'EELV', 'Résistons', 'LR', 'PCF', 'PS', 'DLF', 'NPA', 'LO', 'abstentions', 'blancs', 'nuls']].idxmax(axis=1)

df_pivot.to_csv("/Users/sacha/Documents/Cours Epsi 2023/MSPR1/reformatage_Données/Testrandom.csv", index=False)
